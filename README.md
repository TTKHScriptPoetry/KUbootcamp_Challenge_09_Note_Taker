...
##### Project Description: 
-----------------------------------------------------------------------------------------------------------
##### This project is about developing a Node.js - JSON based web-application that can be used to write and save unlimited number of notes. We name this application Note Taker. In this version not only it can save and retrieve a note via POST and GET methods, respectively, Note Taker can also delete a note through the DELETE method mechanism effectively by clicking on an UI graphical delete-button by design. This project is a combination of both front-end javascripts and back-end routing in utilizing **Express.js** server-side programming. The deployment environment for this project is [heroku](https://heroku.com)
-----------------------------------------------------------------------------------------------------------
###### Some action screenshot of Note Taker are recorded as followed: 
###### Landing page
![landing_page](https://user-images.githubusercontent.com/100046315/158105245-75e9a68e-1045-4f84-888f-3b4f35aaeb70.png)
###### Floppy disk invisibility/visibility 
![floppydisk_not-yet-appeared](https://user-images.githubusercontent.com/100046315/158105275-b10509e5-c7b5-4d54-bd04-d638b712c2fc.png)
